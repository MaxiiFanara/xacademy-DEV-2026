...
import {authRepository} from './auth.container.js'; // ← importamos el authRepository para inyectarlo en el service
...
export const jugadorService = new JugadorService(jugadorRepository, authRepository);
